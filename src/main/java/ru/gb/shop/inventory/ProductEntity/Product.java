...
public class Product {
    ...
    @ManyToOne
    @JoinColumn(name = "product_id", nullable = false, foreignKey = @ForeignKey(name = "FK_product_price_product_id"))
    private ProductPrice price;
    @ManyToOne
    @JoinColumn(name = "discount_id", nullable = false, foreignKey = @ForeignKey(name = "FK_discount_price_product_id"))
